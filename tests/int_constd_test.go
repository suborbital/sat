...
func (i *ConstDIntegrationSuite) SetupSuite() {
	...
	i.cmd.Env = append(os.Environ(), fmt.Sprintf("CONSTD_ATMO_PORT=%d", deltavPort), "CONSTD_EXEC_MODE=metal")
...
func (i *ConstDIntegrationSuite) TestSatEndpoints() {
	...
	baseUrl := fmt.Sprintf("http://localhost:%d", deltavPort)
